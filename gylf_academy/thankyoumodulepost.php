...
if (!empty($_POST['questionnumber'])&& !empty($_POST['module'])&& !empty($_POST['question'])&& !empty($_POST['a'])&& !empty($_POST['b'])&& !empty($_POST['c'])&& !empty($_POST['d'])&& !empty($_POST['e'])&& !empty($_POST['answer'])) {
          ...
          $query   = "INSERT into gylf_academy_module1 (questionnumber,question,a,b,c,d,e,answer,ref_id,created) VALUES('" . $module . "','" . $question . "','" . $a . "','" . $b . "','" . $c . "','" . $d . "','" . $e . "','" . $answer . "','" . $module . "','" . $time_date . "')";
 ...
 <label><font color="#008bc4" size="6px">Question Number:</font></label>
                         ...
                         <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <textarea id="e" name="e" rows="5" style="border:2px solid #008bc4; width: 100%;" required></textarea>
                        </div>
                              <br>
