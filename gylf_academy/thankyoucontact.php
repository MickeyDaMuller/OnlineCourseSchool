...
if (!empty($_POST['email']) && !empty($_POST['name'])&& !empty($_POST['country'])&& !empty($_POST['question'])) {


          $query   = "INSERT into gylf_academy_contact (email,name,country,question,time_date) VALUES('" . $email . "','" . $name . "','" . $country . "','" . $question . "','" . $time_date . "')";
...
//echo "$success";
 ...
 elseif (!empty($_POST['email']) && !empty($_POST['name'])&& !empty($_POST['country'])&& !empty($_POST['question'])) {
...
$mail->Subject = 'GYLF Academy Contact Message Received';
$mail->Body    = "


Hello $name,<br>
Pleasant day to you.<br>
Thank you for contacting us at the GYLF Online Academy.<br>
...
if(!$mail->send()) {
   ...
   echo '<script>alert("Congratulations! Message sent, we would get back to you shortly.")</script>';
