...
if (isset($_REQUEST["my_email"]))
	...
	$com_code = md5(uniqid(rand()));
		  ...
		  $result = mysql_query("select memberId from member_academy where my_email = '$my_email'");
		  $memberId = 0;
		  if (mysql_num_rows($result) == 0)
		  {
		  		 $query= "INSERT into member_academy(fullname, my_email, date) VALUES('".$fullname."', '".$my_email."', ".date("Ymd").")";
		 ...
		 $count = 0; 
		  foreach($name as $invitee_name )
			 ...
			 //echo " Email: ".$invitee_email;
			  ...
			  $qry= "INSERT into invitee_academy( memberId, email, fullname, country,event,com_code) VALUES('".$memberId."', '".$invitee_email."', '".$invitee_name."', '".$invitee_country."', 'invited', '".$com_code."')";
...
-->
 ...
 <SCRIPT TYPE = "text/javascript">
           ...
           <table class="bd" width="100%">
             <tr><td bgcolor="#0099FF" class="hr"><h2 align="center"><span class="headtext">Invite your family and friends to attend the GYLF Online Conference 2017</span> </h2></td></tr></table>
         
	  <form target="_self" method="post" action="member_invite.php" id="f" name="f" ONSUBMIT=" return validation()">
...
$mail->Subject = ucwords($invitee_name).", ".ucwords($fullname)." sent you a link to attend the GYLF Online Academy";
...
<table width="648" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <!--DWLayoutTable-->
  <tr>
    <td width="648" height="27" valign="middle" bgcolor="#3B5998"><div style="color: #FFFFFF; font-family: Arial, Helvetica, sans-serif; font-weight: bold;"><img src="http://www.globalyouthleadersforum.org/assets/images/logoscroll.png" height="50"  />&nbsp;&nbsp;&nbsp;GYLF ONLINE ACADEMY. </div></td>
  </tr>
  <tr>
      ...
      <tr>
        <td height="123">&nbsp;</td>
          <td valign="middle"><div class="style2">Dear  
              ...
              <p>You have been pre-registered for The GYLF Online Academy.<br>
...
<a href="http://globalyouthleadersforum.org/gylf_academy/registrations.php">Complete Registration</a>.<br><br><br>

<b>Link: </b> http://globalyouthleadersforum.org/gylf_academy/registrations.php<br><br>


Thank you<br>

The GYLF Online Academy.<br>
<a href="mailto:enquiries@globalyouthleadersforum
.org">enquiries@globalyouthleadersforum
.org</a> 
...
if(!$mail->send()) {
  ...
  // echo "<div align='center'>Congratulations! You have successfully invited your friends and family.</div>";
   ...
   //header('Location: member_invite.php');
