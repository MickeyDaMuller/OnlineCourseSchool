...
if (!empty($_POST['fullname']) && !empty($_POST['email'])&& !empty($_POST['password'])&& !empty($_POST['country'])) {
  ...
  $sql = "SELECT email FROM users WHERE email = '$email'";
      ...
      $count = mysqli_num_rows($result);
        ...
        if($count == 0){
          ...
          $query   = "INSERT into users (fullname,email,password,country,com_code,created) VALUES('" . $firstname . "','" . $email . "','" . $password . "','" . $country . "','" . $com_code . "','" . $time_date . "')";
...
<select class="form-control" style="border:1px solid blue;" name="country" id="country" required="">
