...
$mail->Subject = 'GYLF Academy Feedback';
$mail->Body    = "

Dear $firstname $surname,<br><br>

We received your feedback. You would hear from us shortly.<br><br>
...
if(!$mail->send()) {
   ...
   echo '<script>alert("Congratulations! Your feedback has been sent. You would hear from us shortly.")</script>';
}
...
//if ($total==0) {
   ...
   //echo '<script>alert("No answer was picked")</script>';
        
         //echo "";
       //}else{

//echo '<script>alert("Total Score = .$total.")</script>';

echo "<h1><b>TOTAL SCORE = ".$scores."</b></h1><br />";

//$query   = "INSERT into users (scores) VALUES('" . $total . "')";
//echo $query;
//$success = $conn->query($query);
 ...
 <br>
 <br>
 <!--div><button type="button" style="background:#008bc4; padding: 15px;color: #ffffff" class="btn btn-default pull-center"><a href="logout.php"><font color="#ffffff">Exit</font></a></button></div-->
