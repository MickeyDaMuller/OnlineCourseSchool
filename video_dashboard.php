...
//echo $video_title;
  ...
  if($_SESSION['startedAss'])
      header("location: assessment_video.php?id=".$video_id);

$sql = "SELECT * FROM academy_scores WHERE user_id = $user_id and video_id = $video_id";
...
<center><h2><b><u><?php echo $video_title ?></u></b></h2></center>


<center><h2><b><u>IMPORTANT INSTRUCTION</u></b></h2></center>
<p>Dear <?php echo $firstname. $space.$surname ?>,<br><br>
...
<li>Prayerfully go through the lecture.</li>
...
<li>Send a feedback to us via email.</li></b>
 ...
 <br>
          ...
          <video id="video" class="video-js vjs-default-skin" width="100%" height="600" style="padding:5px;border:3px solid black;" poster=<?php echo $video_poster ?> controlsList="nodownload" controls data-setup='{}'>
           <source src=<?php echo $video ?> type='video/mp4' label='GYLF' />
           <source src=<?php echo $video_web ?> type='video/webm' label='GYLF'/>
         </video>
         <script>
...
echo "<br>";
echo "<br>";
echo '<center><button type="button" style="background:#008bc4; padding: 15px;color: #ffffff" class="btn btn-default pull-center"><i class="fa fa-plus"></i><a href="assessment_video.php?id= '.$r['video_id'].'"><font color="#ffffff">  Start Assessment</font></a></button></center>';
