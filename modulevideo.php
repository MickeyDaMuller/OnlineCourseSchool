...
$time_date = gmdate("d-M-Y H:i a", time() + 3600*($timezone+date("I")));
          ...
          $query   = "INSERT into gylf_academy_module_video (questionnumber,question,a,b,c,d,answer,ref_id,created) VALUES('" . $questionnumber . "','" . $question . "','" . $a . "','" . $b . "','" . $c . "','" . $d . "','" . $answer . "','" . $module . "','" . $time_date . "')";
      ...
      <nav id="menu">
        <ul>
         ...
         <li><a href="essay.php">Essay Post</a></li>
          <li ><a href="modulepost.php">Quest Post</a></li>
        ...
        <ul>
          ...
          <!--li><a href="scores.php">Scores</a></li-->
           <li class="current"><a href="modulevideo.php">Video Quest</a></li>
         <li><a href="video.php">Video Essay</a></li>
...
<!--div class="divider"></div-->
    ...
    <h2><div style = "background-color:#008bc4; color:#FFFFFF; padding:5px"><center><b>GYLF ACADEMY MODULE</b></center></div></h2>
            ...
            <div style = "margin:20px">
               ...
               <form action = "modulevideo.php" method = "post" id="modulepost" name="modulepost" onsubmit="return(validatePost());">
