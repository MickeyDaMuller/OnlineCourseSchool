...
if (!empty($_POST['firstname']) && !empty($_POST['surname'])&& !empty($_POST['username'])&& !empty($_POST['email'])&& !empty($_POST['password'])&& !empty($_POST['gender'])&& !empty($_POST['age'])&& !empty($_POST['country'])&& !empty($_POST['nationality'])&& !empty($_POST['phone'])&& !empty($_POST['hearus'])&& !empty($_POST['bornagain'])&& !empty($_POST['holy'])) {
...
//echo "$success";
 ...
 elseif (empty($_POST['firstname']) && empty($_POST['surname'])&& empty($_POST['username'])&& empty($_POST['email'])&& empty($_POST['password'])&& empty($_POST['gender'])&& empty($_POST['age'])&& empty($_POST['country'])&& empty($_POST['nationality'])&& empty($_POST['phone'])&& empty($_POST['hearus'])&& !empty($_POST['bornagain'])&& !empty($_POST['holy'])) {
