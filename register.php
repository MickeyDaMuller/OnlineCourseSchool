...
if (!empty($_POST['fullname']) && !empty($_POST['email'])&& !empty($_POST['country'])) {
  ...
  $sql = "SELECT email FROM users WHERE email = '$email'";
      ...
      $count = mysqli_num_rows($result);
        ...
        if($count == 0){
          ...
          $query   = "INSERT into users (firstname,email,country,com_code,created) VALUES('" . $fullname . "','" . $email . "','" . $country . "','" . $com_code . "','" . $time_date . "')";
...
//echo "$success";
 ...
 elseif (empty($_POST['fullname']) && empty($_POST['email'])&& empty($_POST['password'])&& empty($_POST['country'])) {
    ...
    <div id="signup" align="center">
        ...
        <center><p><font size="2.5" color="#008bc4"><strong><u>NB</u>:</strong> Use valid email for verification purpose and maximum image size of 500KB</font></p></center>
            <div style = "margin:20px">
               ...
               <form action = "register.php" method = "post" id="signupform" name="signupform" enctype="multipart/form-data" onsubmit="return(validate());">
